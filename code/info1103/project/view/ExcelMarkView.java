...
public class ExcelMarkView extends AbstractExcelView{
	...
	protected void buildExcelDocument(Map<String, Object> map, HSSFWorkbook workbook,
		...
		// get data
		Map<User, Map<String, Assessment>> studentList = (Map<User, Map<String, Assessment>>) map.get("allStudents");
		...
		// add the values.
		int rowNum=1;
		for(Entry<User, Map<String, Assessment>> student: studentList.entrySet()){
