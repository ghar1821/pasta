...
public class AssessmentDAOold {
	...
	public Map<String, Assessment2> getAssessments(String unikey) {
		...
		Map<String, Assessment2> allAssessments = new TreeMap<String, Assessment2>();
		// get list of files

		for (String s : allAssessmentsList) {
			Assessment2 ass = getAssessment(s, unikey);
			if (ass != null) {
	 ...
	 * @return
	 */
	public Assessment2 loadAssessment(String location, String assessmentName) {
		Assessment2 assess = new Assessment2();
...
//				assess.setSubmissionDate(df2.parse(root.getAttribute("timestamp")));
	 ...
	 */
	public Assessment2 getAssessment(String assessmentName, String unikey) {
	...
	public List<Assessment2> getAssessmentHistory(String unikey, String assessmentName){
		List<Assessment2> history = new ArrayList<Assessment2>();
		Map<Date, Assessment2> history2 = new TreeMap<Date, Assessment2>();
		...
		if(historyFolder.exists()){
			for(File f: historyFolder.listFiles()){
				Assessment2 ass = loadAssessment(f.getAbsolutePath(), assessmentName);
				if(ass != null){
		...
		// reverse history
		ArrayList<Assessment2> assList = new ArrayList<Assessment2>(history2.values());
