...
public class AllStudentAssessmentData {
	...
	private Map<User, Map<String, Assessment2>> studentData;
	...
	private AllStudentAssessmentData(){
		...
		studentData = new TreeMap<User, Map<String, Assessment2>>();
	...
	public void updateStudent(String unikey, List<String> assessments){
		...
		for(String assessment: assessments){
			if(studentData.get(person) == null){
				TreeMap<String, Assessment2> allAssessments = new TreeMap<String, Assessment2>();
	...
	public void updateStudent(String unikey, String assessment){
		User person = userDao.getUser(unikey);
		if(studentData.get(person) == null){
			TreeMap<String, Assessment2> assessments = new TreeMap<String, Assessment2>();
	 ...
	 * @return cached data.
	 */
	public Map<User, Map<String, Assessment2>> getData(){
		return studentData;
	}
